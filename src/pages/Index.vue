<template>
  <q-page padding class="docs-input row justify-center">
    <div style="width: 500px; max-width: 90vw;">
      ...
      <q-input
        v-model="text"
        float-label="Float label & placeholder"
      ...
      <q-input
        v-model="password"
        type="password"
        float-label="Password with no toggle button"
        no-pass-toggle
      />
      ...
      <q-input
        ...
        type="number"
        prefix="$"
        stack-label="Number with prefix"
      />
      <q-input
        v-model="num"
        type="number"
        stack-label="Number with prefix, suffix, clearable"
        prefix="$"
        suffix="TSP"
        clearable
      />
      <q-input
        ...
        :step="2"
        prefix="$"
        stack-label="With step 2, use arrow keys"
      />
      <q-input
        v-model="floatNum"
        type="number"
        ...
        :step="1.4"
        prefix="$"
        stack-label="Float with step 1.4, use arrow keys"
      />
      ...
      <q-input
        ...
        inverted
        color="brown"
        stack-label="Number aligned to right"
      />
      ...
      <span class="chip-container">
        <q-chip square color="secondary"> Model: {{ lazy }} </q-chip>
      </span>
      ...
      <q-input
        v-model="text"
        inverted
        float-label="Icon when input has content"
      ...
      <q-input
        v-model="password"
        float-label="Minimum 5 characters password"
        inverted-light
        color="amber"
        type="password"
        :after="[
          { icon: 'done', condition: password.length >= 5, handler() {} },
        ]"
      />
      <q-input
        v-model="email"
      ...
      <q-input
        ...
        inverted-light
        color="amber"
        float-label="Read only & inverted"
      />
      <q-input
        rows="5"
        v-model="area"
        readonly
        type="textarea"
        float-label="Read only textarea"
      />
      <q-input
        rows="5"
        v-model="area"
        ...
        inverted
        type="textarea"
        float-label="Read only & inverted textarea"
      />
      ...
      <q-input
        ...
        inverted
        type="textarea"
        float-label="Disabled & inverted textarea"
      />
      ...
      <div class="dark-example">
        ...
        >
          <q-input v-model="text" dark color="yellow" float-label="Wifi name" />
        </q-field>
      </div>
